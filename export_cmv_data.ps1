...
Write-Host "Exporting 2.Custo Mercadoria Vendida from Port $port..."
$dax = @"
EVALUATE
SUMMARIZECOLUMNS(
    DCALENDARIO[ANO],
    ...
    VMQ_CADDRE[TITULO],
    VMQ_TGFNAT[DESCRNAT],
    FILTER(VMQ_CADDRE, VMQ_CADDRE[BLOCO] = "2.Custo Mercadoria Vendida"),
    "ORCADO", [ORCAMENTO],
    "REALIZADO", [REALIZADO.],
...
$outCsv = "$PWD\cmv_data_export.csv"
